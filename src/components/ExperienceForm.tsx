...
export function ExperienceForm({ onSubmitted }: { onSubmitted?: () => void }) {
  ...
  return (
    <div>
      <h3 className="text-center text-xl font-bold sm:text-2xl">{dict.experience.title}</h3>
      <p className="mx-auto mt-3 max-w-md text-center text-sm leading-relaxed text-navy-soft dark:text-cream-dark">
